...
```
```
The output was what I expected it to be. I thought that R would be smart
enough to realize that the input was an integer, so it would convert it
to a string before passing into the toupper() function.
```
